...
function Section({ id, title, children }: { id?: string; title: string; children: React.ReactNode }) {
  return (
    <section id={id} className="mb-14 print-section">
      <h2
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-3">
        <span className="font-serif text-base uppercase tracking-widest" style={{ color: tier === "FREE" ? "var(--primary)" : GOLD }}>
          Phase {phase} — {name}
        </span>
        <span
...
function FeatureRow({ icon, name, description, tier }: { icon: string; name: string; description: string; tier: string }) {
  return (
    <tr className="border-b border-border/20">
      <td className="py-3 px-4 font-mono text-xs uppercase tracking-wider text-foreground/80 whitespace-nowrap">
        <span className="mr-2">{icon}</span>{name}
      </td>
      <td className="py-3 px-4 text-xs text-muted-foreground leading-relaxed">{description}</td>
      <td className="py-3 px-4 font-mono text-[10px] uppercase whitespace-nowrap" style={{ color: tier === "FREE" ? "var(--primary)" : GOLD }}>
        {tier}
      </td>
    </tr>
  );
  ...
  return (
    <>
      ...
      <div className="hidden print:flex items-center justify-center mb-12 pt-8">
        ...
        <div>
          <div className="font-serif text-3xl uppercase tracking-widest" style={{ color: GOLD }}>Code of Reality</div>
      ...
      <div ref={guideRef} className="max-w-4xl mx-auto pb-24 print:pb-8 print:max-w-full">
        ...
        <div className="print:hidden flex items-center justify-between mb-10">
          ...
          <button
            ...
            className="flex items-center gap-2 font-mono text-xs uppercase tracking-widest px-5 py-2.5 transition-all"
            style={{
        ...
        <header className="mb-16 text-center">
          <div className="font-mono text-[10px] uppercase tracking-widest mb-6" style={{ color: GOLD + "80" }}>
            Ascendancy Technologies · Confidential
          </div>
          <h1 className="font-serif text-6xl uppercase tracking-widest leading-tight mb-4" style={{ color: GOLD }}>
            User Guide
          </h1>
          ...
          <div className="mt-8 mx-auto w-32 h-px" style={{ background: `linear-gradient(to right, transparent, ${GOLD}, transparent)` }} />
        </header>
        ...
        <Section id="executive-summary" title="Executive Summary">
          ...
          <SubSection title="Platform Purpose">
            <p className="text-sm text-muted-foreground leading-relaxed mb-4">
              ...
              of Reality operates at a deeper layer — the <em className="text-foreground/80">reality-construction architecture</em> —
              the mental models, identity narratives, emotional charge patterns, and environmental feedback
              loops that determine which behaviors are even possible for a given individual.
            </p>
            <p className="text-sm text-muted-foreground leading-relaxed">
              By working systematically through all eight phases, practitioners dismantle outdated
              reality constructs, install precision-engineered replacements, and develop the internal
              coherence required to maintain an elevated reality field under resistance. The result is
              not motivation or willpower — it is a structurally different human operating system.
            </p>
          </SubSection>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                ...
                <div
                  key={title}
                  className="p-4"
                  style={{ background: "rgba(212,175,55,0.04)", border: "1px solid rgba(212,175,55,0.15)", clipPath: CLIP }}
                >
          ...
          <SubSection title="Subscription Architecture">
            <p className="text-sm text-muted-foreground leading-relaxed mb-4">
              The platform operates on a tiered access model. Phases 1–4 (21 chapters) are fully accessible
              on the free tier, providing a complete foundation and genuine transformation entry point.
              Phases 5–8 and the AI Coach require an ARCHITECT subscription ($49/month). The CERTIFIED
              tier ($99/month) provides the full platform experience including advanced certification tracks.
            </p>
          </SubSection>
          ...
          <SubSection title="Who This Platform Is For">
            <p className="text-sm text-muted-foreground leading-relaxed">
              ...
              anyone committed to operating at maximum intentional coherence. The platform is NOT
              a casual wellness tool — it demands active engagement, honest self-assessment, and
              willingness to confront deeply-held reality constructs.
            </p>
          </SubSection>
        </Section>
          ...
          <SubSection title="Account Creation">
            <ol className="space-y-3 text-sm text-muted-foreground">
              {[
                ...
                ["Access the Command Center", "Your dashboard (Command Center) is now active. It displays your live coherence metrics, current phase, and quick-action pathways."],
        ...
        <Section id="phases" title="The Eight Phases — Complete Curriculum">
          <p className="text-sm text-muted-foreground leading-relaxed mb-8">
            The 42-chapter curriculum is organized into eight progressive phases. Each phase
            builds structurally on the previous — attempting to skip phases produces unstable results.
            Phases 1–4 are accessible on the free tier. Phases 5–8 require ARCHITECT subscription.
          </p>

          <PhaseBlock
            phase={1} name="Awakening" tier="FREE"
          ...
          <PhaseBlock
            phase={2} name="Clearing" tier="FREE"
          ...
          <PhaseBlock
            phase={3} name="Mapping" tier="FREE"
          ...
          <PhaseBlock
            phase={4} name="Crystallizing" tier="FREE"
          ...
          <PhaseBlock
            phase={5} name="Weaving" tier="ARCHITECT"
          ...
          <PhaseBlock
            phase={6} name="Transmitting" tier="ARCHITECT"
          ...
          <PhaseBlock
            phase={7} name="Mastering" tier="ARCHITECT"
          ...
          <PhaseBlock
            phase={8} name="Transcending" tier="ARCHITECT"
        ...
        <Section id="features" title="Complete Feature Reference">
          ...
          <SubSection title="Command Center (Dashboard)">
            ...
            <Callout>
              <strong className="text-foreground/80">Coherence Level</strong> — Aggregate score (0–10) derived from
              chapter completions, session frequency, assessment results, and intention hit-rate.<br /><br />
              <strong className="text-foreground/80">Vector Magnitude</strong> — Measures the directional strength
              and stability of your reality vector. Higher magnitude = greater intentional force applied
              to your target reality.
            </Callout>
          </SubSection>

          <SubSection title="Phase Pathway">
            <p className="text-sm text-muted-foreground leading-relaxed mb-3">
              Visual map of all 42 chapters across 8 phases. Each chapter card shows completion
              status, phase/sequence position, and access tier. Clicking an accessible chapter opens
              the full chapter transmission. Phase 5–8 chapters display an ARCHITECT badge and upgrade
              prompt for free-tier users.
            </p>
            <p className="text-sm text-muted-foreground leading-relaxed">
          ...
          <SubSection title="Session Journal">
            <p className="text-sm text-muted-foreground leading-relaxed mb-3">
              Timestamped practice log for recording integration sessions, insight transmissions,
              pattern observations, and coherence events. The journal is the primary evidence-collection
              system for your transformation — the longitudinal record of your reality field in motion.
            </p>
            <p className="text-sm text-muted-foreground leading-relaxed">
              <strong className="text-foreground/80">Best practice:</strong> Log a session within 24 hours of
              completing any chapter or assessment. Include: what you noticed, what shifted, what resistance
              arose, and what integration action you will take. Consistency of logging is more valuable
              than length of entries.
            </p>
          </SubSection>

          <SubSection title="Sessions Tracker">
            <p className="text-sm text-muted-foreground leading-relaxed">
              High-level session engagement tracker. Monitors practice streaks, session frequency,
              total engagement hours, and phase velocity (rate of progression through the curriculum).
              Streak maintenance is incentivized through the achievement system and contributes to
          ...
          <SubSection title="Community Field">
            <p className="text-sm text-muted-foreground leading-relaxed">
              Collective practitioner space for resonance amplification. Sharing insights, challenges,
              and breakthroughs in a community of aligned practitioners creates a collective reality
              field that amplifies individual work. The community is organized by phase, allowing
              practitioners to connect with others at the same integration level.
            </p>
          </SubSection>
          ...
          <SubSection title="E₈ AI Reality Coach">
            <div
              className="flex items-center gap-2 mb-3 text-xs font-mono uppercase tracking-widest px-3 py-1.5 w-fit"
            ...
            <p className="text-sm text-muted-foreground leading-relaxed mb-3">
              ...
              coaching across all aspects of your transformation work. The coach has access to your
              phase position, assessment results, active intentions, and session history, enabling
              genuinely relevant, specific coaching rather than generic motivational content.
            </p>
            <p className="text-sm text-muted-foreground leading-relaxed">
              <strong className="text-foreground/80">Use the AI Coach for:</strong> unpacking resistance
              patterns encountered in chapter work, designing custom integration protocols, getting
              clarity on intention architecture, exploring advanced applications of phase concepts,
              and processing challenging coherence events in real time.
            </p>
          </SubSection>
          ...
          <SubSection title="Achievement System">
            <p className="text-sm text-muted-foreground leading-relaxed">
              ...
              and special transmissions including the final E₈ Integration achievement for
              completing all 42 chapters. Achievements contribute to your overall coherence
              record and are permanently associated with your practitioner profile.
            </p>
          </SubSection>
        </Section>
            ...
            {[
              {
                ...
                features: [
                  "Phases 1–4 (21 chapters)",
                  "Dimensional Assessment",
                  "Intentions Architecture",
                  "Identity Matrix",
                  "Session Journal",
                  "Community Field",
                  "Reality Analytics (basic)",
                  "Achievement System",
                ],
                locked: []
              },
        ...
        <Section id="faq" title="Frequently Asked Questions">
          {[
            ...
            <div key={i} className="mb-6">
              <div
                className="p-4 mb-0"
                style={{ background: `${GOLD}08`, borderLeft: `2px solid ${GOLD}60` }}
              >
                <p className="font-mono text-xs uppercase tracking-wider text-foreground/90">{q}</p>
              </div>
              <div className="p-4 text-sm text-muted-foreground leading-relaxed" style={{ background: "rgba(255,255,255,0.02)", borderLeft: "2px solid rgba(255,255,255,0.05)" }}>
                {a}
              </div>
            </div>
          ))}
